...
- **本期成绩单**（2026-W37，23 案全库，数字出期文 The ladder 表）：swe-2-max 18/23 全库榜首，SWE-2 档线单调 15 < 16 < 18；swe-1-7-medium 14/23，glm-5-2 6/23；柱下小字 = 公共 21 案子集。
  ![W37 成绩单：五模型柱](docs/images/scorecard-2026-w37.png)
- **案面画像**（2026-W37 Full matrix 单表，face × 模型热力图，色深 = 分面通过率）：swe-2-max 运维面 6/6 史上首个全清；SWE-2 三档 UI 搭建连过；核验面五模型全部 0/3。
