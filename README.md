...
| 期 | 内容 | 结论 |
|---|---|---|
| [2026-W37](results/2026-W37.md) | swe-1-7-medium + glm-5-2 双模型全库首考(23 案) | medium 14/23(子集 12/21,全科无零面,免费道全能);glm-5-2 6/23 但成史上第二个过 UI 搭建案的模型;glm 交付契约零遵守(6 卷喷聊天不写文件)=运行级失格 |
