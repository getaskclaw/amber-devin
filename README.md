...
| 期 | 内容 | 结论 |
|---|---|---|
| [2026-W37](results/2026-W37.md) | swe-1-7-medium + glm-5-2 + swe-2-high 三模型全库(23 案) | swe-2-high 16/23(子集 14/21,发布日当晚首考:UI 搭建案史上第三过且首个满分 12/12,但丢掉家门审查案首过);medium 14/23(子集 12/21,审查案 A-cdc3d11a 全部已发布矩阵首过);glm-5-2 6/23 但成史上第二个过 UI 搭建案的模型,交付契约零遵守=运行级失格 |
